...
> NOTE: these docs need to be improved the next time I run through procedure.
...
# if above not available, I've included a copy of the file in this document
...
If the above python file obtained via `wget` is not available, you can try the following:
